   ...
   Texture::Texture(SDL_Renderer& target_native_renderer, Surface const& source_surface)
      : native_texture_{
         [](SDL_Renderer& target_native_renderer, SDL_Surface& source_surface)
         {
            ...
            runtime_assert(succeeded, "failed to set the target rendering context ({})",
               SDL_GetError());
            ...
            runtime_assert(succeeded, "failed to reset the target rendering context ({})",
               SDL_GetError());
   ...
   Texture::Texture(SDL_Renderer& target_native_renderer, Texture const& source_texture)
      : native_texture_{
         [](SDL_Renderer& target_native_renderer, SDL_Texture& source_native_texture)
         {
            ...
            runtime_assert(succeeded, "failed to set the source rendering context ({})",
               SDL_GetError());
            ...
            runtime_assert(succeeded, "failed to reset the source rendering context");
