...
namespace fro
{
	Font* ResourceManager::findFont(std::string name)
	{
	...
	Music* ResourceManager::findMusic(std::string name)
	{
	...
	SoundEffect* ResourceManager::findSoundEffect(std::string name)
	{
	...
	Surface* ResourceManager::findSurface(std::string name)
	{
