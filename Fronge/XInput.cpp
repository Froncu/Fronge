...
namespace fro
{
	class InputManager::GameControllerInputImplementation final
	{
	public:
...
std::unique_ptr<fro::InputManager::GameControllerInputImplementation>
fro::InputManager::m_pIMPLEMENTATION{ std::make_unique<GameControllerInputImplementation>() };

void fro::InputManager::processGamePadInputContinous()
{
