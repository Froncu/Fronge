...
#include "fronge/concepts/arithmetic.hpp"
#include "fronge/pch.hpp"
#include "fronge/utility/resulting_component.hpp"
   ...
   struct Vector2 final
   {
      ...
      [[nodiscard]] Component& operator[](std::size_t const index)
      {
         switch (index)
         {
            ...
            default:
               throw std::runtime_error{ std::format("index {} is outside the [0, 1] range!", index) };
         }
      }
